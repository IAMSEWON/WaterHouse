...
export default function Home() {
  ...
  const handleSplashStart = () => {
    ...
    if (videoRef.current) {
      ...
      gt.to(videoRef.current, {
        ...
        duration: 1,
        ease: "power2.out"
      }).set(videoRef.current, { display: "block" });
    }
  };
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-black">
      ...
      <video ref={videoRef} preload="auto" onLoadedData={() => console.log('hello')} className="fixed top-0 left-0 w-full h-full z-0 object-cover hidden opacity-0" width="1920" height="1080" loop controls={false} playsInline muted >
